      ...
      <div className="home-wrapper flex justify-between pt-[1.2rem]">
        <div className="text_left_container flex flex-col justify-center gap-3">
          ...
          <h2 className="text-xl">
            Effortless, Permissionless Domain Creation
          </h2>
          <p>
            Claim your unique domain and bring your token’s vision to life in
            the digital space. Increase token utility and market value with
            integrated domain creation and ownership features. No approvals, no
            limits—just a seamless way to manage your token and its digital
            presence.
          </p>
        </div>
